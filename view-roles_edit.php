...
<body>
                            ...
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                        ...
                                        <div id="addmodulemodalE" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" style="margin-top: 200px;">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="email" class="control-label mb-10">Module:<code>*</code></label>
                                                                <select class="form-control selectbox" name="m_module" id="my_module" onchange="gts();">
                                                                <?php 
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label mb-10">Control:</label>
                                                             <select class="form-control" name="m_ctrl" id="m_ctrl">
                                                                <option>View</option>
                                                    ...
                                                    <br>
                                                     <span id="check-itemE" style='color:red'></span>
                                                <!--      <div id="words"> -->
                                    ...
                                    <div class="table-wrap mt-40" id="testref">
                                             ...
                                             <?php
                                                    ...
                                                    while($row=mysqli_fetch_array($result)){
                                                        ...
                                                        <tr id="tb-<?php echo $row['m_id']; ?>">
                                                            ...
                                                            <td ><input type="text" name="m_modules" class="select" style="border: none;"  value="<?php echo $row['m_module']; ?>"></td>

                                                            <td ><input type="text" name="m_ctrls" style="border: none;" value="<?php echo $row['m_ctrl']; ?>"></td>

                                                            <td><button type="button" class=" btn btn-danger validate" onclick="count();">Remove</button></td>
                                      ...
                                      <input type="text" name="cdm1" id="cdm1" hidden>
    ...
    <script src="dist/js/user-role.js"></script>
