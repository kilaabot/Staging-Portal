                            ...
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="email" class="control-label mb-10">Module:<code>*</code></label>
                                                                <select class="form-control selectbox" name="m_module" id="m_module">
                                                                <?php 
                                                    ...
                                                    <br>
                                                     <span id="check-item"></span>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input type="button" name="add" value="Add" id="EaddBtn" class="btn btn-primary" data-dismiss="modal"  onclick="addModule();">
                                                        </div>
                                                 </div>
                                                <!-- /.modal-content -->
                                            </div>
                                    ...
                                    <br>
                                        ...
                                        <div class="form-group">
                                            <a href="#" class="btn btn-primary btn-outline btn-icon right-icon m-ad" onclick="resetF()"><span>Add Module</span> <i class="fa fa-plus-circle"></i> </a>
                                        </div>
